            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.plan*',3)}}">
                        <i class="menu-icon las la-ruler-combined"></i>
                        <span class="menu-title">@lang('Manage Plan')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.plan*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.plan.list')}} ">
                                <a href="{{route('admin.plan.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Plan')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.return.intervel.list')}} ">
                                <a href="{{route('admin.return.intervel.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Return Intervel')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.plan.investment.list')}}">
                    <a href="{{route('admin.plan.investment.list')}}" class="nav-link ">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.referral')}}">
                    <a href="{{route('admin.referral')}}" class="nav-link ">
                        <i class="menu-icon las la-money-check-alt"></i>
                        <span class="menu-title">@lang('Referral Level')</span>
                    </a>
                </li>
