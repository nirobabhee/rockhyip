                        ...
                        <div class="plan-card">
                            <div class="plan-card__head">
                                ...
                                @if ($plan->interest_status == 1)
                                    <h4 class="mt-0 mb-2 text-center">
                                        <small class="text--danger" title="Return On Investment">
                                            @lang('ROI ')</small>{{ $plan->interest }}%
                                    </h4>
                                @else
                                    <h4 class="mt-0 mb-2 text-center">
                                        <small class="text--danger" title="Return On Investment">
                                            @lang('ROI ')</small>
                                        {{ $general->cur_sym . showAmount($plan->interest) }}
                                    </h4>
                                @endif
                            ...
                            <div class="plan-card__footer text-center mt-4">
                                @guest
                                    ...
                                    <a data-toggle="collapse" data-target="#plan-{{ $plan->id }}" href="javascript:void(0)"
                                        class="t-link btn btn--dark btn--lg rounded-pill">
                                        @lang('Invest Now')
                                    </a>
