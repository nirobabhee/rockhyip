                                ...
                                @if ($logs)
                                    @forelse ($logs as  $data)
                                        <tr>
                                            ...
                                            <td data-label="@lang('Gateway')">{{ __(@$data->gateway->name) }}
                                            </td>
                                            ...
                                            <td data-label="@lang('Time')"> <i class="fa fa-calendar"></i>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item dark-bg">@lang('Conversion Rate') : <span
                                    class="withdraw-rate"></span>
                            </li>
                            <li class="list-group-item dark-bg">@lang('Payable Amount') : <span
                                    class="withdraw-payable"></span>
                            </li>
                        </ul>
