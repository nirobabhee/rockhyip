...
*/
// Cron
Route::get('/cron', 'CronController@roiCalculation')->name('cron');
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Time-intervel
        Route::get('return/intervel', 'ReturnIntervelController@index')->name('return.intervel.list');
        Route::post('return/intervel/store', 'ReturnIntervelController@store')->name('return.intervel.store');
        Route::post('return/intervel/update/{id}', 'ReturnIntervelController@update')->name('return.intervel.update');
        ...
        //Investment
        Route::get('plan/investment/list', 'PlanController@investmentList')->name('plan.investment.list');
        Route::get('plan/investment/details/{id}', 'PlanController@investmentDetails')->name('plan.investment.details');

        //Referral
        Route::get('referral', 'ReferralController@index')->name('referral');
        Route::post('referral', 'ReferralController@store')->name('referral');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //auth user plans
            Route::get('/invested/plan', 'PlanController@investedPlanList')->name('invested.plans');
        });
    });
});

Route::post('/subscribe', 'SiteController@subscribeStore')->name('subscribe');
...
// team-member
Route::get('expert/{id}/{slug}', 'SiteController@viewExpertMember')->name('expert.member');

//--Plan--//
Route::get('user/plans', 'PlanController@plan')->name('all.plan');
Route::post('investment/plan/{id}', 'PlanController@investmentPlan')->name('investment.plan');
Route::get('/chart', 'SiteController@chart')->name('chart');
